use core::traits::TryInto; // PATCH(cairo-2.11)
use core::fmt::{Debug, Error, Formatter};
use core::traits::DivRem; // PATCH(cairo-2.11): upstream 2.12 path is core::num::traits::DivRem
...
> of MerkleVerifierTrait<H> {
    ...
    fn verify(
        ...
        let computed_root = loop {
            ...
            let (parent_position, parity) = DivRem::div_rem(child_position, 2_u32.try_into().expect('div_by_zero')); // PATCH(cairo-2.11)
